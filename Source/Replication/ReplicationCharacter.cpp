...
AReplicationCharacter::AReplicationCharacter()
{
	...
	CameraBoom->SetRelativeRotation(FRotator(0.f,-50.f,0.f));
...
void AReplicationCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AReplicationCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AReplicationCharacter::MoveRight);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AReplicationCharacter::OnResetVR);
}


void AReplicationCharacter::OnResetVR()
{
